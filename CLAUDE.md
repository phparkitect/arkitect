...
- The parser supports a configurable target PHP version (`--target-php-version`, `8.0`–`8.6`); when touching `FileVisitor`/analyzer code, consider syntax across that range.
