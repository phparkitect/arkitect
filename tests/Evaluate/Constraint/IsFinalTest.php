...
final class IsFinalTest extends TestCase
{
    ...
    {
        $violations = (new IsFinal())->evaluate(ParsedClassFixture::create('App\Foo', isFinal: true, line: 12), new ParsedClassGraph())->violations;
    ...
    {
        $violations = (new IsFinal())->evaluate(ParsedClassFixture::create('App\Foo', isFinal: false, line: 12), new ParsedClassGraph())->violations;
