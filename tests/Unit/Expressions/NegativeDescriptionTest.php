...
class NegativeDescriptionTest extends TestCase
{
    ...
    {
        $description = new PositiveDescription('should [depend|not depend] only on classes: Domain');
        ...
        $this->assertEquals('should not depend only on classes: Domain', $negativeDescription->toString());
    }
}
